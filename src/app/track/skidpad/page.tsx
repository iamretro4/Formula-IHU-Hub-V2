...
export default function SkidpadEventPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center p-8">
        ...
        <span className="ml-2">Loading skidpad event...</span>
      </div>
    )
  }
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Skidpad Event</h1>
            <p className="text-gray-600">Figure-8 handling test on 15.25m diameter circles</p>
          </div>
        </div>
